                        ...
                        <div class="pt-bio-panel">
                            ...
                            <div class="pt-bio-grid">
                                ...
                                <div class="pt-bio-row">
                                    ...
                                    <span class="pt-bio-value">{{#if (gt stats.vag_depth_pct 100)}}{{stats.vag_depth_pct}}% \xB7 womb{{else}}{{clampPercent stats.vag_depth_pct}}%{{/if}}</span>
                                </div>
...
function sendConfigError(userId, message, operation = "load") {
  try {
